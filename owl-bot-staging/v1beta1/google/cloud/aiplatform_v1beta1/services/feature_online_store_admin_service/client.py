...
class FeatureOnlineStoreAdminServiceClient(metaclass=FeatureOnlineStoreAdminServiceClientMeta):
    ...
    @staticmethod
    def feature_online_store_path(project: str,location: str,feature_online_store: str,) -> str:
        """Returns a fully-qualified feature_online_store string."""
        return "projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}".format(project=project, location=location, feature_online_store=feature_online_store, )

    @staticmethod
    def parse_feature_online_store_path(path: str) -> Dict[str,str]:
        """Parses a feature_online_store path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureOnlineStores/(?P<feature_online_store>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def feature_view_path(project: str,location: str,feature_online_store: str,feature_view: str,) -> str:
        """Returns a fully-qualified feature_view string."""
        return "projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}".format(project=project, location=location, feature_online_store=feature_online_store, feature_view=feature_view, )

    @staticmethod
    def parse_feature_view_path(path: str) -> Dict[str,str]:
        """Parses a feature_view path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureOnlineStores/(?P<feature_online_store>.+?)/featureViews/(?P<feature_view>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def feature_view_sync_path(project: str,location: str,feature_online_store: str,feature_view: str,) -> str:
        """Returns a fully-qualified feature_view_sync string."""
        return "projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}/featureViewSyncs/feature_view_sync".format(project=project, location=location, feature_online_store=feature_online_store, feature_view=feature_view, )

    @staticmethod
    def parse_feature_view_sync_path(path: str) -> Dict[str,str]:
        """Parses a feature_view_sync path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureOnlineStores/(?P<feature_online_store>.+?)/featureViews/(?P<feature_view>.+?)/featureViewSyncs/feature_view_sync$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FeatureOnlineStoreAdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            FeatureOnlineStoreAdminServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FeatureOnlineStoreAdminServiceClient._read_environment_variables()
        self._client_cert_source = FeatureOnlineStoreAdminServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FeatureOnlineStoreAdminServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, FeatureOnlineStoreAdminServiceTransport)
    ...
    def create_feature_online_store(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_feature_online_store]
    ...
    def get_feature_online_store(self,
    ...
    def list_feature_online_stores(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_feature_online_stores]
    ...
    def update_feature_online_store(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_feature_online_store]
    ...
    def delete_feature_online_store(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_feature_online_store]
    ...
    def get_feature_view_sync(self,
    ...
    def list_feature_view_syncs(self,
