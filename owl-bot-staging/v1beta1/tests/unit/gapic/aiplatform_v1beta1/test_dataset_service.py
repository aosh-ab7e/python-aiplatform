...
from google.cloud.aiplatform_v1beta1.services.dataset_service import DatasetServiceAsyncClient
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DatasetServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DatasetServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DatasetServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DatasetServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DatasetServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DatasetServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DatasetServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DatasetServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DatasetServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DatasetServiceClient))
...
def test__get_api_endpoint():
    ...
    default_endpoint = DatasetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DatasetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DatasetServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DatasetServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DatasetServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DatasetServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DatasetServiceClient._get_api_endpoint(None, None, default_universe, "always") == DatasetServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DatasetServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DatasetServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DatasetServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DatasetServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DatasetServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DatasetServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DatasetServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DatasetServiceClient._get_universe_domain(None, None) == DatasetServiceClient._DEFAULT_UNIVERSE
...
def test_dataset_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DatasetServiceClient, transports.DatasetServiceGrpcTransport, "grpc", grpc_helpers),
    (DatasetServiceAsyncClient, transports.DatasetServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_dataset_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_dataset_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_import_data_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [dataset.ImportDataConfig(gcs_source=io.GcsSource(uris=['uris_value']))]
        assert arg == mock_val
...
def test_export_data_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = dataset.ExportDataConfig(gcs_destination=io.GcsDestination(output_uri_prefix='output_uri_prefix_value'))
        assert arg == mock_val
...
def test_create_dataset_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_dataset_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_create_dataset_version_async(transport: str = 'grpc_asyncio', request_type=dataset_service.CreateDatasetVersionRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_dataset_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_dataset_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_dataset_version_async(transport: str = 'grpc_asyncio', request_type=dataset_service.DeleteDatasetVersionRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_dataset_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_dataset_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_dataset_version_async(transport: str = 'grpc_asyncio', request_type=dataset_service.GetDatasetVersionRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataset_version.DatasetVersion(
            name='name_value',
            etag='etag_value',
            big_query_dataset_name='big_query_dataset_name_value',
        ))
...
@pytest.mark.asyncio
async def test_list_dataset_versions_async(transport: str = 'grpc_asyncio', request_type=dataset_service.ListDatasetVersionsRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_dataset_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataset_version.DatasetVersion)
                   for i in results)
...
def test_restore_dataset_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_dataset_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_restore_dataset_version_async(transport: str = 'grpc_asyncio', request_type=dataset_service.RestoreDatasetVersionRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_data_items_async(transport: str = 'grpc_asyncio', request_type=dataset_service.SearchDataItemsRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataset_service.SearchDataItemsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_search_data_items_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, dataset_service.DataItemView)
                   for i in results)
...
async def test_search_data_items_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.search_data_items(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
@pytest.mark.asyncio
async def test_list_saved_queries_async(transport: str = 'grpc_asyncio', request_type=dataset_service.ListSavedQueriesRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(dataset_service.ListSavedQueriesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_saved_queries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, saved_query.SavedQuery)
                   for i in results)
...
@pytest.mark.asyncio
async def test_delete_saved_query_async(transport: str = 'grpc_asyncio', request_type=dataset_service.DeleteSavedQueryRequest):
    client = DatasetServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_dataset_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.dataset_service.transports.DatasetServiceTransport.__init__') as Transport:
...
def test_dataset_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.dataset_service.transports.DatasetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_dataset_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.dataset_service.transports.DatasetServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DatasetServiceTransport()
        adc.assert_called_once()
...
def test_dataset_version_path():
    ...
    expected = "projects/{project}/locations/{location}/datasets/{dataset}/datasetVersions/{dataset_version}".format(project=project, location=location, dataset=dataset, dataset_version=dataset_version, )
    actual = DatasetServiceClient.dataset_version_path(project, location, dataset, dataset_version)
    assert expected == actual
...
def test_saved_query_path():
    ...
    dataset = "cuttlefish"
    saved_query = "mussel"
    expected = "projects/{project}/locations/{location}/datasets/{dataset}/savedQueries/{saved_query}".format(project=project, location=location, dataset=dataset, saved_query=saved_query, )
    actual = DatasetServiceClient.saved_query_path(project, location, dataset, saved_query)
    assert expected == actual
