...
from google.cloud.aiplatform_v1beta1.services.index_service import IndexServiceAsyncClient
...
def test_index_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.index_service.transports.IndexServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_index_async(transport: str = 'grpc_asyncio', request_type=index_service.CreateIndexRequest):
...
@pytest.mark.asyncio
async def test_get_index_async(transport: str = 'grpc_asyncio', request_type=index_service.GetIndexRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_indexes_async(transport: str = 'grpc_asyncio', request_type=index_service.ListIndexesRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_index_async(transport: str = 'grpc_asyncio', request_type=index_service.UpdateIndexRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_index_async(transport: str = 'grpc_asyncio', request_type=index_service.DeleteIndexRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_upsert_datapoints_async(transport: str = 'grpc_asyncio', request_type=index_service.UpsertDatapointsRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_remove_datapoints_async(transport: str = 'grpc_asyncio', request_type=index_service.RemoveDatapointsRequest):
    client = IndexServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_index_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.index_service.transports.IndexServiceTransport.__init__') as Transport:
...
def test_index_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.index_service.transports.IndexServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_index_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.index_service.transports.IndexServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.IndexServiceTransport()
        adc.assert_called_once()
