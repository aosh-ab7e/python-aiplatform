...
@pytest.mark.asyncio
async def test_raw_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.RawPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_stream_raw_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamRawPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_direct_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.DirectPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_direct_raw_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.DirectRawPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_stream_direct_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamDirectPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_stream_direct_raw_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamDirectRawPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_streaming_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamingPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_server_streaming_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamingPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_streaming_raw_predict_async(transport: str = 'grpc_asyncio', request_type=prediction_service.StreamingRawPredictRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_generate_content_async(transport: str = 'grpc_asyncio', request_type=prediction_service.GenerateContentRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_stream_generate_content_async(transport: str = 'grpc_asyncio', request_type=prediction_service.GenerateContentRequest):
    client = PredictionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
