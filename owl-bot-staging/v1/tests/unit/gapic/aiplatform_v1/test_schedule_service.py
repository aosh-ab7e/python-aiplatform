...
from google.cloud.aiplatform_v1.services.schedule_service import ScheduleServiceAsyncClient
...
def test_schedule_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.schedule_service.transports.ScheduleServiceGrpcTransport.__init__') as grpc_transport:
...
def test_schedule_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.schedule_service.transports.ScheduleServiceTransport.__init__') as Transport:
...
def test_schedule_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.schedule_service.transports.ScheduleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_schedule_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.schedule_service.transports.ScheduleServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ScheduleServiceTransport()
        adc.assert_called_once()
