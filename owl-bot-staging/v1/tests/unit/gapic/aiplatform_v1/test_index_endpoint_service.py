...
from google.cloud.aiplatform_v1.services.index_endpoint_service import IndexEndpointServiceAsyncClient
...
def test_index_endpoint_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.index_endpoint_service.transports.IndexEndpointServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_mutate_deployed_index_async(transport: str = 'grpc_asyncio', request_type=index_endpoint_service.MutateDeployedIndexRequest):
    client = IndexEndpointServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_index_endpoint_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.index_endpoint_service.transports.IndexEndpointServiceTransport.__init__') as Transport:
...
def test_index_endpoint_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.index_endpoint_service.transports.IndexEndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_index_endpoint_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.index_endpoint_service.transports.IndexEndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.IndexEndpointServiceTransport()
        adc.assert_called_once()
