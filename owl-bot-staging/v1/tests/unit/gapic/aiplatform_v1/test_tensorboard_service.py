...
from google.cloud.aiplatform_v1.services.tensorboard_service import TensorboardServiceAsyncClient
from google.cloud.aiplatform_v1.services.tensorboard_service import TensorboardServiceClient
...
def test__get_client_cert_source():
    ...
    assert TensorboardServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert TensorboardServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source
...
def test_tensorboard_service_client_from_service_account_info(client_class, transport_name):
...
def test_tensorboard_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_tensorboard_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class", [
    TensorboardServiceClient, TensorboardServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (TensorboardServiceClient, transports.TensorboardServiceGrpcTransport, "grpc", grpc_helpers),
    (TensorboardServiceAsyncClient, transports.TensorboardServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_tensorboard_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_tensorboard_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.tensorboard_service.transports.TensorboardServiceGrpcTransport.__init__') as grpc_transport:
...
def test_tensorboard_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_read_tensorboard_usage(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.read_tensorboard_usage),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_read_tensorboard_usage_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.ReadTensorboardUsageRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_size(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.read_tensorboard_size),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_read_tensorboard_size_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.ReadTensorboardSizeRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(tensorboard_service.ReadTensorboardSizeResponse(
            storage_size_byte=1826,
        ))
...
def test_batch_create_tensorboard_runs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_create_tensorboard_runs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_batch_create_tensorboard_runs_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.BatchCreateTensorboardRunsRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(tensorboard_service.BatchCreateTensorboardRunsResponse(
        ))
...
def test_batch_create_tensorboard_runs_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_create_tensorboard_runs(
            parent='parent_value',
            requests=[tensorboard_service.CreateTensorboardRunRequest(parent='parent_value')],
        )
        ...
        assert arg == mock_val
        arg = args[0].requests
        mock_val = [tensorboard_service.CreateTensorboardRunRequest(parent='parent_value')]
        assert arg == mock_val
...
def test_batch_create_tensorboard_time_series(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tensorboard_service.BatchCreateTensorboardTimeSeriesResponse(
        )
...
@pytest.mark.asyncio
async def test_batch_create_tensorboard_time_series_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.BatchCreateTensorboardTimeSeriesRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(tensorboard_service.BatchCreateTensorboardTimeSeriesResponse(
        ))
...
def test_batch_create_tensorboard_time_series_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_create_tensorboard_time_series(
            parent='parent_value',
            requests=[tensorboard_service.CreateTensorboardTimeSeriesRequest(parent='parent_value')],
        )
        ...
        assert arg == mock_val
        arg = args[0].requests
        mock_val = [tensorboard_service.CreateTensorboardTimeSeriesRequest(parent='parent_value')]
        assert arg == mock_val
...
def test_batch_read_tensorboard_time_series_data(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse(
        )
...
@pytest.mark.asyncio
async def test_batch_read_tensorboard_time_series_data_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse(
        ))
...
@pytest.mark.asyncio
async def test_write_tensorboard_experiment_data_async(transport: str = 'grpc_asyncio', request_type=tensorboard_service.WriteTensorboardExperimentDataRequest):
    client = TensorboardServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_tensorboard_experiment_data_flattened():
    ...
    with mock.patch.object(
        ...
        client.write_tensorboard_experiment_data(
            tensorboard_experiment='tensorboard_experiment_value',
            write_run_data_requests=[tensorboard_service.WriteTensorboardRunDataRequest(tensorboard_run='tensorboard_run_value')],
        )
        ...
        mock_val = [tensorboard_service.WriteTensorboardRunDataRequest(tensorboard_run='tensorboard_run_value')]
        assert arg == mock_val
...
def test_write_tensorboard_run_data_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = [tensorboard_data.TimeSeriesData(tensorboard_time_series_id='tensorboard_time_series_id_value')]
        assert arg == mock_val
...
def test_tensorboard_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.tensorboard_service.transports.TensorboardServiceTransport.__init__') as Transport:
...
def test_tensorboard_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.tensorboard_service.transports.TensorboardServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_tensorboard_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.tensorboard_service.transports.TensorboardServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TensorboardServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (TensorboardServiceAsyncClient, transports.TensorboardServiceGrpcAsyncIOTransport),
])
