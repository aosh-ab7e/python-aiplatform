...
class FeatureOnlineStoreServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[FeatureOnlineStoreServiceTransport]]
...
class FeatureOnlineStoreServiceClient(metaclass=FeatureOnlineStoreServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FeatureOnlineStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            FeatureOnlineStoreServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FeatureOnlineStoreServiceClient._read_environment_variables()
        self._client_cert_source = FeatureOnlineStoreServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FeatureOnlineStoreServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
    ...
    def fetch_feature_values(self,
            request: Optional[Union[feature_online_store_service.FetchFeatureValuesRequest, dict]] = None,
            *,
        ...
        if not isinstance(request, feature_online_store_service.FetchFeatureValuesRequest):
